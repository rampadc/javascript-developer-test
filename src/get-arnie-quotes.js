...
const getArnieQuotes = async (urls) => {
  ...
  // 4. If the request fails, the body contains the reason of the failure
  ...
  // 6. Return a list of all objects [{'Arnie Quote': <quote> }, {'FAILURE': <reason from mock http server>}], in the same order as the URLs I got
